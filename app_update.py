...
def score_position(board, piece):
	...
	# Uu tien cot trung tam
	# Moi o o trung tam duoc +3 diem vi o o trung tam la uu tien (chien thuan)
...
def minimax(board, depth, alpha, beta, maximizingPlayer):
	...
	if maximizingPlayer:
		...
		ordered_moves = order_moves(board, valid_locations, AI_PIECE)
		...
		value = math.inf
		column = random.choice(valid_locations)
		ordered_moves = order_moves(board, valid_locations, PLAYER_PIECE)
		for col in ordered_moves:
			row = get_next_open_row(board, col)
			b_copy = board.copy()
